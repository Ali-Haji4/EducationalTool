...
export default function MessagingInterfaceTutors() {

    const getUserID = localStorage.getItem("userID");
    const getAccountType = localStorage.getItem("accountType");
    const getSenderID = localStorage.getItem("tutor_id");
    const getSenderName = localStorage.getItem("tutor_name");
    const getSenderDegree = localStorage.getItem("tutor_degree");
    const getSenderEmail = localStorage.getItem("tutor_email");
            ...
            {getAccountType == "Student" ?<NavBarStudent/> : <NavBarTutor/>}
                        <div className="chatInterface">
                            ...
                            <div className="chatHeader">
                                <h2>Message Dr. {getSenderName}</h2>
                                <h4>{getSenderDegree} Tutor|| {getSenderEmail}</h4>
                            </div>
